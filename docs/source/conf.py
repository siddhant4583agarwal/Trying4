...
sys.path.insert(0, os.path.abspath("../../Trying4"))

# -- Project information -----------------------------------------------------

project = "Trying4"
copyright = "2023, Siddhant Agarwal"
author = "Siddhant Agarwal"

# The short X.Y version
version = metadata.version("Trying4")
# The full version, including alpha/beta/rc tags
release = metadata.version("Trying4")
...
# documentation.
html_theme_options = {
    "github_url": "https://github.com/siddhant4583agarwal/Trying4",
    "repository_url": "https://github.com/siddhant4583agarwal/Trying4",
